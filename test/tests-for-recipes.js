...
describe('Recipes', function() {
  ...
  it('should get recipe list on GET', function() {
  ...
  it('should add recipes on POST', function() {
    const newRecipe = {
      name: 'coffee', ingredients: ['coffee beans', 'hot water']};
    return chai.request(app)
      .post('/recipes')
      .send(newRecipe)
      .then(function(res) {
  ...
  it('should delete targeted recipe on DELETE', function() {
    return chai.request(app)
      .get('/recipes')
      .then(function(res) {
        return chai.request(app)
